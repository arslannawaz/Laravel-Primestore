...
<head>
    ...
    {!! Html::style('../theme/vendors/datatables.net-bs/css/dataTables.bootstrap.min.css') !!}
    {!! Html::style('../theme/vendors/datatables.net-buttons-bs/css/buttons.bootstrap.min.css') !!}
    {!! Html::style('../theme/vendors/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css') !!}
    {!! Html::style('../theme/vendors/datatables.net-responsive-bs/css/responsive.bootstrap.min.css') !!}
    {!! Html::style('../theme/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css') !!}
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fas fa-list-alt"></i> Categories <span class="fa fa-chevron-down"></span></a>
                            ...
                            <li><a><i class="fab fa-product-hunt"></i> Products <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
{{--
                                    <li><a href="{{route('admin.product.create')}}">All Products</a></li>
--}}
                                    <li><a href="{{route('admin.product.index')}}">Approve Products</a></li>
...
{!!Html::script('../theme/vendors/pnotify/dist/pnotify.nonblock.js')!!}
        ...
        {!!Html::script('../theme/vendors/datatables.net/js/jquery.dataTables.min.js')!!}
        {!!Html::script('../theme/vendors/datatables.net-bs/js/dataTables.bootstrap.min.js')!!}
        {!!Html::script('../theme/vendors/datatables.net-buttons/js/dataTables.buttons.min.js')!!}
        {!!Html::script('../theme/vendors/datatables.net-buttons-bs/js/buttons.bootstrap.min.js')!!}
        {!!Html::script('../theme/vendors/datatables.net-buttons/js/buttons.flash.min.js')!!}
        {!!Html::script('../theme/vendors/datatables.net-buttons/js/buttons.html5.min.js')!!}
        {!!Html::script('../theme/vendors/datatables.net-buttons/js/buttons.print.min.js')!!}
        {!!Html::script('../theme/vendors/datatables.net-fixedheader/js/dataTables.fixedHeader.min.js')!!}
        {!!Html::script('../theme/vendors/datatables.net-keytable/js/dataTables.keyTable.min.js')!!}
        {!!Html::script('../theme/vendors/datatables.net-responsive/js/dataTables.responsive.min.js')!!}
        {!!Html::script('../theme/vendors/datatables.net-responsive-bs/js/responsive.bootstrap.js')!!}
        {!!Html::script('../theme/vendors/datatables.net-scroller/js/dataTables.scroller.min.js')!!}
        {!!Html::script('../theme/vendors/jszip/dist/jszip.min.js')!!}
        {!!Html::script('../theme/vendors/pdfmake/build/pdfmake.min.js')!!}
        {!!Html::script('../theme/vendors/pdfmake/build/vfs_fonts.js')!!}
